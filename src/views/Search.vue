<template>
    ...
    <div class="searchHistory" v-show="keyWordList.length>0">
...
<script>
    ...
    export default {
        data() {
            return {
                keyWordList: [],
                searchKey: "", //用来接收输入的关键字
                searchList: [],
            }
        },
        mounted() {
            this.keyWordList = JSON.parse(localStorage.getItem('keyWordList')) ? JSON.parse(localStorage.getItem(
                'keyWordList')) : []
        },
        methods: {
